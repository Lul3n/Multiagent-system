# ESTE ARCHIVO SOLO ES UNICAMENTE PARA FUNCIONES QUE LIMPIAN LA INFORMACI├ôN DEL JSON, HAY MUCHAS IRREGULARIDADES CON LA INFORMACI├ôN
...
# retorna un diccionario con la forma que estandarice para manejar la informaci├│n del doctor, practicamente solo asigna las keys y los valores del diccionario
...
# Recorre todos los doctores y aplica la limpieza de los doctores a cada doctor para devolver el array de todos los diccionarios con la informaci├│n de los doctores.
