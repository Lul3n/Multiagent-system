...
# Consigue la posici├│n de un valor respecto a los demas (el rango percentil), se ordenan los valores y determina
...
# en esta funcion es ponderar la calificaci├│n real con la calificacion global promedio del data set entero, todos los
# este ajuste solo afecta a los doctores con pocas reviews, no afecta practicamente la calificaci├│n de los doctores con
